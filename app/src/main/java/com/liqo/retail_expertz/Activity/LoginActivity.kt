...
import com.liqo.retail_expertz.databinding.ActivityLoginBinding

import com.liqo.retail_expertz.viewmodelactivity.LoginViewModel
        ...
        try {
            ...
            if (tag == ApiContants.login) {
                ...
                if (loginModel.error == false) {
                    ...
                    PrefManager.putString(ApiContants.Role, loginModel.data.role)
